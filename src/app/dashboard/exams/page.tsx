          ...
          <form onSubmit={handleStudentSubmit} className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div
                  className={`border-2 border-dashed rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all duration-200 bg-[var(--surface-secondary)] ${studentQPaper ? "border-emerald-500/50 bg-emerald-500/5" : "border-[var(--border-subtle)] hover:border-brand-500/50"
                    }`}
                ...
                >
                  ...
                  />
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${studentQPaper ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" : "bg-[var(--surface-primary)] text-[var(--text-tertiary)] border-[var(--border-subtle)]"
                    }`}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div
                  className={`border-2 border-dashed rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all duration-200 bg-[var(--surface-secondary)] ${studentAnswer ? "border-emerald-500/50 bg-emerald-500/5" : "border-[var(--border-subtle)] hover:border-brand-500/50"
                    }`}
                  style={{ padding: "36px 20px", gap: "12px", position: "relative" }}
                >
                  <input
                    ...
                    className="absolute inset-0 opacity-0 cursor-pointer"
                  />
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${studentAnswer ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" : "bg-[var(--surface-primary)] text-[var(--text-tertiary)] border-[var(--border-subtle)]"
                    }`}>
  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-fade-in relative z-10">
      ...
      <div className="flex flex-col gap-2.5 pb-4 mt-2">
        <div className="live-status-badge flex items-center gap-2.5 text-[11px] font-mono font-bold uppercase bg-[#e0ff82]/10 px-6 py-2 rounded-full w-max mt-1 mb-3">
        ...
        <div className="bg-[var(--surface-primary)] border border-[var(--border-subtle)] rounded-2xl p-5 shadow-sm flex justify-between items-center gap-4">
          {[
            ...
            <div key={s.num} className="flex-1 flex items-center gap-3 relative">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[12px] font-bold border transition-all duration-300 ${step === s.num
              ...
              <div className="flex flex-col">
                <span className={`text-[11px] font-mono uppercase tracking-wider font-bold ${step === s.num ? "text-[#e0ff82]" : step > s.num ? "text-emerald-600" : "text-[var(--text-tertiary)]"
                  }`}>Step 0{s.num}</span>
                <span className={`text-[12.5px] font-medium leading-none mt-0.5 ${step === s.num ? "text-[var(--text-primary)] font-semibold" : "text-[var(--text-secondary)]"
                  }`}>{s.label}</span>
              </div>
              {s.num < 4 && (
                <div className={`hidden md:block flex-1 h-[2px] mx-4 transition-all duration-300 ${step > s.num ? "bg-emerald-500/30" : "bg-[var(--border-subtle)]"
                  }`} />
              )}
            </div>
          ))}
            ...
            {isLoadingCycles ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {cycles.map((c) => (
                  <div
                    key={c.id}
                    className={`border rounded-xl p-6 cursor-pointer transition-all duration-300 hover:scale-[1.01] hover:shadow-md ${selectedCycleId === c.id
                  ...
                  >
                    <div className="flex justify-between items-start gap-2 mb-2">
                      ...
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border whitespace-nowrap ${c.status === "ACTIVE"
              ...
              <div className="flex flex-col gap-3 pb-4 border-b border-[var(--border-subtle)]">
                <div className="flex justify-between items-center flex-wrap gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`text-[11px] font-bold py-1 px-3 rounded-full ${rubricApprovalStatus === "APPROVED"
              ...
              {runStatus ? (
                <div className="w-full max-w-[500px] border border-[var(--border-subtle)] rounded-2xl p-6 bg-[var(--surface-secondary)]/30 backdrop-blur-sm flex flex-col gap-4 text-left shadow-md">
                  <div className="flex justify-between items-center pb-2.5 border-b border-[var(--border-subtle)]">
                    ...
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${runStatus.status === "COMPLETED"
                      ? "bg-emerald-500/10 text-emerald-600"
