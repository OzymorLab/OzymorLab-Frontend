  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-fade-in relative z-10">
      ...
      <div className="flex flex-col gap-2.5 pb-4 mt-2">
        <div className="flex items-center gap-2.5 text-[11px] font-mono font-bold text-black dark:text-[#e0ff82] uppercase bg-[#e0ff82]/10 px-4 py-1.5 rounded-full w-max border border-[#e0ff82] shadow-sm shadow-[#e0ff82]/10">
          <span className="w-1.5 h-1.5 rounded-full bg-black dark:bg-[#e0ff82] animate-pulse" />
